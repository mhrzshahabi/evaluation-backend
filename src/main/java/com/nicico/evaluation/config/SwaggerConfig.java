...
public class SwaggerConfig {
    ...
    @Value("${spring.security.oauth2.client.provider.oserver.token-uri-swagger}")
    ...
    public Docket productApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.nicico.evaluation.controller"))
