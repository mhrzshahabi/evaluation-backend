...
@Order(Ordered.HIGHEST_PRECEDENCE) // kelasi ke status code ra migarad va javab midahad
//@ControllerAdvice
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleConflictException(ConstraintViolationException e) {
