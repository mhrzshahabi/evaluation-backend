...
public class ErrorResponse {
    ...
    ErrorResponse(ErrorType errorCode, String field, String message) {
        ...
        Optional<StackTraceElement> stackTraceElement = Arrays.stream(Thread.currentThread().getStackTrace()).filter(q -> q.getClassName().matches("com\\.nicico\\.evaluation\\.service\\..*")).findFirst();
