...
public class EvaluationConstant {
    ...
    public static final String ACTIVE_MERIT = "Active-Merit";
    public static final String REVOKED_MERIT = "Revoked-Merit";
    public static final String REJECT_MERIT = "Reject-Merit";
    public static final String AWAITING_CREATE_MERIT = "Awaiting-Create-Merit";
